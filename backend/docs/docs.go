...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/auth/send-otp/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Send Login OTP Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.sendLoginOTPRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.sendSignupOTPRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.DynamicEntry"
                            }
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreatePositionRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.StepRule"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateWorkflowStepRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/workflows/{id}/steps/{step_id}/submit": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "handlers.CreatePositionRequest": {
            "type": "object",
            "required": [
                "department_id",
                "description",
        ...
        "handlers.CreateWorkflowStepRequest": {
            "type": "object",
            "required": [
                "name",
                "position_entity_id",
